      ...
      <div className="xl:grid xl:grid-cols-3 xl:gap-8">
        <div className="grid grid-cols-2 gap-8 xl:col-span-2">
          <div className="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h2 className="text-sm font-semibold leading-5 tracking-wider text-gray-400 uppercase">
                Solutions
              </h2>
              <ul className="mt-4">
                <li>
        ...
        <div className="mt-8 xl:mt-0">
          ...
          <form className="mt-4 sm:flex sm:max-w-md">
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button className="flex items-center justify-center w-full px-5 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-pink-700 border border-transparent rounded-md hover:bg-pink-400 focus:outline-none focus:bg-pink-400">
                Subscribe
              </button>
            </div>
          </form>
